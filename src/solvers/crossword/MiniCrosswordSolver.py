...
SYSTEM_PROMPT = (
    ...
    "- Clue and answer share part of speech, tense, and number, and are interchangeable "
    "in a sentence: a plural clue -> plural answer (usually +S); a past-tense clue -> "
    "past-tense answer (usually +ED/+D); an '-ing' clue -> '-ing' answer.\n"
    "- A clue ending in '?' is wordplay -- the answer is NOT a direct synonym; read it "
    "literally or as a pun ('Spot remover?' -> SHOO; 'Bottom line?' -> HEM; 'Dotted "
    "line?' -> ANI).\n"
    "- Abbreviation cues -- an 'Abbr.' / 'briefly' / 'for short' tag, or an abbreviated "
    "word in the clue ('Assn.' -> ORG, 'grp.' -> an acronym) -- mean the answer is "
    "itself an abbreviation.\n"
    "- Foreign answers are signaled by naming the language/place OR by another word of "
    "that language in the clue ('Summer on the Seine' -> ETE, French for summer; "
    "'Friend, in France' -> AMI).\n"
    "- Fill-in-the-blank and '___' clues are completed literally, often a common phrase, "
    "name, or brand.\n"
    "- Casual/slang/pop-culture clues take slang or proper-noun answers (NEATO, JCREW, "
    "OKED); embrace names and brands.\n"
    "- Roman-numeral clues use I=1 V=5 X=10 L=50 C=100 D=500 M=1000 (a smaller numeral "
    "before a larger subtracts, e.g. IX=9).\n"
    "- Every answer must be a REAL word, name, phrase, or abbreviation -- NEVER invent "
    "letters to fit a length or crossing.\n"
    "- Short slots are usually recurring 'crosswordese'; when the known letters fit, "
    "strongly prefer these frequent answers:\n"
    "  3: ERA ERE ESE ENE NNE SSE ETA ETE RTE STE SRA IRA TSE ELO EPA ESP AMA AVE ADO "
    "ADE AGE AIR ALA ALE ALI ARE EAR EEL EON ERR EWE ICE IRE ODE OAR OAT OBI OLE ORE "
    "ORO RES RIO NEE NAT LEE IAN ITO ABE EVE AHA RAH ENS ESS UTE ANT APE\n"
    "  4: OREO OLEO ALOE ARIA ANTE ACRE AREA IDEA ISLE OBOE EPEE ETUI ESSE ESTE ETAL "
    "ETRE ETON ETNA EDEN EIRE ERIE ERIN ESSO ASIA UTAH ARES EROS ENOS ESAU EDNA ELIA "
    "ERLE ERIC OMAR NERO RENO ANNA ELLA ETTA ARLO ENID ERTE ALTO ASEA ASHE OGRE EMIR "
    "IDOL EARL TSAR USER ORAL AMEN EGAD ALAS IOTA NESS ELAL\n"
